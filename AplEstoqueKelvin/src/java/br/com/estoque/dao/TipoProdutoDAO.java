   ...
   private Connection conexao;
    ...
    public Boolean alterar(Object objeto) {
        ...
        try{
            ...
            try{
                System.out.println("Problemas ao alterar o TipoProduto! Erro: "+ex.getMessage());
                ex.printStackTrace();
                conexao.rollback();
            }catch (SQLException e){
                System.out.println("Erro: +"+e.getMessage());
    ...
    public Boolean excluir(int numero) {
        ...
        try{
            ...
            System.out.println("Problemas ao excluir a TipoProduto! Erro:"
                    + ex.getMessage());
    ...
    public List<Object> listar() {
       ...
       try {
           ...
           System.out.println("Problemas ao listar TipoProduto"
                   + ex.getMessage());
        } 
      return resultado;
    }
