...
public class UnidadeMedidaDAO implements GenericDAO{
    ...
    public Boolean alterar(Object objeto) {
        ...
        try{
            ...
            try{
                System.out.println("Problemas ao alterar o UnidadeMedida! Erro: "+ex.getMessage());
                ex.printStackTrace();
                conexao.rollback();
            }catch (SQLException e){
                System.out.println("Erro: +"+e.getMessage());
    ...
    public Boolean excluir(int numero) {
        ...
        try{
            ...
            System.out.println("Problemas ao excluir a UnidadeMedida! Erro:"
                    + ex.getMessage());
    ...
    public List<Object> listar() {
       ...
       try {
           ...
           System.out.println("Problemas ao listar UnidadeMedida"
                   + ex.getMessage());
        } 
      return resultado;
    }
