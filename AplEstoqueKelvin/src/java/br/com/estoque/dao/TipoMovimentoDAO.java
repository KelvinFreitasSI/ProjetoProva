...
public class TipoMovimentoDAO implements GenericDAO{
    ...
    public Boolean inserir(Object objeto) {
        ...
        try{
            ...
            try{
                System.out.println("Problemas ao cadastrar a TipoMovimento! Erro: "+ex.getMessage());
                ex.printStackTrace();
                conexao.rollback();
        ...
        String sql = "update tipomovimento set descricao=? where idtipomovimento=?";
         ...
         try{
            ...
            return true;
             ...
             try{
                 System.out.println("Problemas ao alterar a TipoMovimento ! Erro: "+ex.getMessage());
                 ex.printStackTrace();
                 conexao.rollback();
             }catch (SQLException e) {
                 System.out.println("Erro:"+e.getMessage());
    ...
    public Boolean excluir(int numero) {
        ...
        try{
            ...
            System.out.println("Problemas ao excluir a TipoMovimento! Erro:"
                    + ex.getMessage());
    ...
    public List<Object> listar() {
       ...
       try {
           ...
           System.out.println("Problemas ao listar TipoMovimento! Erro:"
                   + ex.getMessage());
        } 
      return resultado;
    }   
