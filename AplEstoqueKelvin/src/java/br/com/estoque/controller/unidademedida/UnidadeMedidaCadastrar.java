    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (dao.cadastrar(oUnidadeMedida)){
                mensagem = "UnidadeMedida cadastrado com sucesso!";
            }else{
                mensagem = "Problemas ao cadastrar UnidadeMedida. Verifique os dados informados e tente novamente!";
                }
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("UnidadeMedidaListar");
            
        }catch(Exception ex){
            System.out.println("Problemas no Servlet ao cadastrar UnidadeMedida! Erro" + ex.getMessage());
