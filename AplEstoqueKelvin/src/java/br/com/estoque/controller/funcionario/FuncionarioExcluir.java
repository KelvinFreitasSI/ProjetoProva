...
public class FuncionarioExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
           ...
           if (dao.excluir(idFuncionario)){
               mensagem ="Funcionario excluido com sucesso";
        } else{
               mensagem = "Problemas ao excluir Funcionario";
           }
           request.setAttribute("mensagem", mensagem);
           response.sendRedirect("FuncionarioListar");
    } catch (Exception ex){
           System.out.println("Problemas no servelet ao excluir Funcionario! Erro:"+ ex.getMessage());
           ex.printStackTrace();
    }
    }
