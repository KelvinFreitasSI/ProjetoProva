 ...
 * @author kelvi
 */
@WebServlet(name = "TipoProdutoExcluir", urlPatterns = {"/TipoProdutoExcluir"})
public class TipoProdutoExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
           ...
           if (dao.excluir(idTipoProduto)){
               mensagem ="tipo produto excluido com sucesso";
        } else{
           ...
           System.out.println("Problemas no servelet ao excluir TipoProduto! Erro:"+ ex.getMessage());
           ex.printStackTrace();
    }
    }
